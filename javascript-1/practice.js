...
// Create a function called 'iLove' that takes in two string parameters, 'name' and 'love'. Have the function take the two parameters and return
//  a string that says "NAMEPARAM loves LOVEPARAM" with the appropriate parameters in the string. e.g. "Joseph loves music"
...
let me = {
	...
	age: 24,
	greeter: function(){
		return `Hello! My name is ${firstName} and I lve in ${state}`
	}
}
