...
let me = {
    firstName: "jason",
    superHeroName: "slim shady",
    homeTown: "pleasant grove",
    superPowers: ["flight", "invisibility", "intelligence"],
...
// and it should receive its value from the value of your firstName key on the me object above. The next variable is 'superName' which should have its value 
// assigned as the value of the superHeroName property on the me object. The last variable you should create is 'homeTown' which will be the value of homeTown 
// on the me object
...
//////////////////Step 4////////////////////
//Create a function called 'setColor' that takes in one parameter called 'arr' that is an array of colors. Make sure that we only ever have three colors 
// by using splice to trim the array to just 3 colors. 

// Next, create a for loop to loop over the remaining three colors. If any of the colors is 'blue', change it's value to '#4D4DFF' (which is just a more 
// appealing shade of blue). Outside of the for loop but still inside of setColor, invoke the function called 'background' which will take in three arguments. 
...
//////////////////Step 5////////////////////
//Create a function called 'setPowers' that takes in 'arr' as a parameter. In your setPowers function, loop over the arr parameter and run a function we 
// created called createLi(), which will take each item of the array as an argument. Remember, you did not create the createLi function. The createLi function 
...
// and you need to remove all info about them. That is what this function will do. In your function, loop over the obj parameter passed in, and change each keys 
// value to 'redacted'. Outside of the loop but still in the redactInfo function, run the function redacted() which is a function we created that will update the 
// text on the screen.
